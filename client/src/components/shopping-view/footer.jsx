export default () => {
  ...
  return (
    <footer className="pt-10">
      <div className="max-w-screen-xl mx-auto md:px-4 lg:px-0">
        <div className="justify-between items-center gap-5 md:gap-12 flex flex-col md:flex-row">
        ...
        <div className="flex-1 mt-16 justify-between flex">
          {footerNavs.map((item, idx) => (
            <ul className="text-gray-600" key={idx}>
        ...
        <div className="mt-10 py-10 border-t items-center justify-between flex md:flex-row flex-col">
          <p className="text-gray-600">
            © 2022 Float UI Inc. All rights reserved.
          </p>
          <div className="flex items-center gap-x-6 text-gray-400 mt-4 md:mt-0">
